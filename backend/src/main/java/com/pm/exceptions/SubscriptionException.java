...
public class SubscriptionException extends RuntimeException {
    ...
    public SubscriptionException(String message, String errorCode, int httpStatus) {
        super(message);
    ...
    public SubscriptionException(String message, String errorCode, int httpStatus, Throwable cause) {
        super(message, cause);
        this.errorCode = errorCode;
        this.httpStatus = httpStatus;
    }
